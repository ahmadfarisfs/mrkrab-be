...
func NewMutationStore(projectStore *ProjectStore, db *gorm.DB) *MutationStore {
...
func (ms *MutationStore) ListMutation(req utils.CommonRequest) ([]model.MutationExtended, int, error) {
	return []model.MutationExtended{}, 0, nil
}
...
// 		Order("t.transaction_date desc").Table("mutations").
